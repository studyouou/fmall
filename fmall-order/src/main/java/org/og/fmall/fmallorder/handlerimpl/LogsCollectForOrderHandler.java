...
public class LogsCollectForOrderHandler implements InvokeHandler {
    ...
    private SimpleDateFormat simpleDateFormat = new SimpleDateFormat("yyyy-MM-ss hh:mm:ss:SSS");
    ...
    public void handle(RequestParam requestParam, ResponseContext context) {
        try {
            ...
            stringBuilder.append(order.getId()).append(" ").append(simpleDateFormat.format(new Date())).append(" ")
